...
\usepackage[
    pdftex,
    hidelinks,
    pdftitle={CSE Cracks 20XX - Regular Expressions},
    pdfcreator={Quiz Generator},
    pdfkeywords={Version: 5af4960a-d}
]{hyperref}
...
\fancyhead[C]{Regular Expressions}
\fancyhead[R]{20XX}
\renewcommand{\headrulewidth}{0.1mm}
\fancyfoot{}
\fancyfoot[R]{\thepage}
\fancyfoot[L]{Version: 5af4960a-d}
...
\begin{center}
    \begin{tabular}{ c }
        \includegraphics[width=0.5\textwidth]{/home/eriq/code/cse-cracks-course/quizzes/regex/questions/ice-breaker/xkcd-regular-expressions.png} \\
    \end{tabular}
\end{center}
...
\end{lstlisting}
    ...
    \bigAnswerBox{2cm}{1.0}{numerical}{5}{0}{0}
\end{minipage}
...
\begin{minipage}{\textwidth}
    ...
    \calcremainingheight
    \bigAnswerBox{\remainingheight}{1.0}{essay}{10}{0}{0}
\end{minipage}
